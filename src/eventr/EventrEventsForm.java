...
public class EventrEventsForm extends javax.swing.JFrame implements MouseListener{
    ...
    private void generatePreBuiltEventList()
    {
        ...
        birdWatchingEvent.setWhen("8:00 a.m. April 6, 2024");
        ...
        volleyBall.setWhen("3:00 p.m. on Sunday, April 7, 2024");
        ...
        basketBallGame.setWhen("7:30 p.m. on Saturday, April 6, 2024");
        ...
        footBallGame.setWhen("1:00 p.m. Saturday, April 6, 2024");
    ...
    private void initComponents() {
        ...
        whenTextInput = new javax.swing.JTextField();
        ...
        whenTextInput.setText("Enter Here");
        whenTextInput.setPreferredSize(new java.awt.Dimension(340, 26));
        whiteSpace3.add(whenTextInput);
          ...
          public void run()
          {
              ...
              if (800 - y <= yConstraint)
              {
                  ...
                  createPanel.setLocation(0, yConstraint);
                   ...
                   whenTextInput.setEditable(true);
...
private void TitleSlideDown() 
    ...
    private javax.swing.JTextField whenTextInput;
        ...
        else if (e.getSource() == createButton)
   {
       ...
       newEvent.setWhen(whenTextInput.getText());
